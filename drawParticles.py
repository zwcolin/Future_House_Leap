...
backgroundsource = background.CreateSource((10, 10), initspeed = 20.0, initdirection = 2.35619449, initspeedrandrange = 2.0, initdirectionrandrange = 1.0, particlesperframe = 5, particlelife = 125, drawtype = PyIgnition.DRAWTYPE_SCALELINE, colour = (255, 255, 255), length = 10.0)
...
fireworkblast = background.CreateCircle(pos = (200,200), colour = (0, 0, 0), bounce = 1.5, radius = 100.0)
